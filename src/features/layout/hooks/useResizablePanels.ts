...
const STORAGE_KEY_SIDEBAR = "agentsmanager.sidebarWidth";
const STORAGE_KEY_RIGHT_PANEL = "agentsmanager.rightPanelWidth";
const STORAGE_KEY_PLAN_PANEL = "agentsmanager.planPanelHeight";
const STORAGE_KEY_TERMINAL_PANEL = "agentsmanager.terminalPanelHeight";
const STORAGE_KEY_DEBUG_PANEL = "agentsmanager.debugPanelHeight";
